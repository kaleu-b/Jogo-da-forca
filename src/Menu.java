        ...
        do {
            ...
            switch (opcao) {
                case '1': // Opção para iniciar um novo jogo
                    ...
                    System.out.print("Escolha o número de rodadas (de 1-10, inteiro e positivo): ");

                    int rodadas = input.nextInt();
                   
                    while (rodadas < 1 || rodadas > 10) { // Validação do número de rodadas. não pode ser menor que 1 ou maior que 10
                        System.out.println("Número de rodadas inválido! Por favor, escolha um número entre 1 e 10.");
                        System.out.print("Tente novamente: ");
                        rodadas = input.nextInt(); // Solicita nova entrada até ser válida
                    }

                    Forca.iniciarJogo(multiplayer, rodadas); // Chama o método que inicia a lógica principal do jogo, passando o modo de jogo e o número de rodadas
                    break;
